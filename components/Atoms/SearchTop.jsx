  ...
  return (
      <div className='hidden w-full' id='search'>
        <form onSubmit={searchAction} className='w-full flex items-center justify-between mt-2 bg-sky-500 dark:text-white'>
            ...
            <button type='submit' className="bg-transparent"><FontAwesomeIcon icon={faSearch} className="px-5 flex items-center justify-center text-white text-2xl lg:text-xl bg-transparent" /></button>
        </form>
    </div>
  )
}
