      ...
      <div className="w-full">
        <div className="flex items-center justify-between text-white font-bold mx-2 lg:mx-0">
            ...
            <ul className='lg:flex lg:relative lg:items-center lg:w-full lg:space-x-3 hidden lg:bg-transparent lg:h-0 bg-white w-3/4 fixed h-screen z-50 right-0 top-0 px-5 py-2 space-y-5 lg:space-y-0 lg:px-0 lg:py-2' id='navbar'>
                ...
                <hr />
                <Link href={"/"}><li className='text-sm lg:text-xs lg:font-semibold text-gray-600 font-thin block hover:bg-red-700 hover:underline hover:duration-300 hover:ease-in-out uppercase cursor-pointer lg:text-white '>Home</li></Link>
            ...
            <div className="w-28 text-right flex justify-around items-center">
                ...
                <label class="swap">
                    ...
                    <div class={`${language == "in" ? "swap-on" : "swap-off"} dark:text-white font-bold font-main text-sm`}>ENG</div>
                    <div class={`${language == "en" ? "swap-on" : "swap-off"} dark:text-white font-bold font-main text-sm`}>IND</div>
                </label>
