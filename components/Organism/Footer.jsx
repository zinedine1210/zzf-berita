            ...
            <div className="container px-6 mx-auto space-y-6 divide-y divide-gray-400 md:space-y-12 divide-opacity-50">
                <div className="grid lg:grid-cols-10 space-y-5 lg:space-y-0">
                    ...
                    <div className="col-span-6 text-center md:text-left md:col-span-2">
                        ...
                        <ul>
                            <li className='my-1 text-gray-400 dark:text-white'>
                                <Link href={`/kategori?page=1&category=HUKUM-KRIMINAL`}><span className='hover:text-sky-500 font-thin font-mono text-gray-300 cursor-pointer'>{bahasa("category.0.text")}</span></Link>
                            </li>
                            <li className='my-1 text-gray-400 dark:text-white'>
                                <Link href={`/kategori?page=1&category=PERISTIWA`}><span className='hover:text-sky-500 font-thin font-mono text-gray-300 cursor-pointer'>{bahasa("category.1.text")}</span></Link>
                            </li>
                            <li className='my-1 text-gray-400 dark:text-white'>
                                <Link href={`/kategori?page=1&category=PEMBINAAN-MASYARAKAT`}><span className='hover:text-sky-500 font-thin font-mono text-gray-300 cursor-pointer'>{bahasa("category.2.text")}</span></Link>
                            </li>
                            <li className='my-1 text-gray-400 dark:text-white'>
                                <Link href={`/kategori?page=1&category=SOSIAL`}><span className='hover:text-sky-500 font-thin font-mono text-gray-300 cursor-pointer'>{bahasa("category.3.text")}</span></Link>
                            </li>
                        </ul>
                    </div>
                    <div className="col-span-6 text-center md:text-left md:col-span-2">
                        ...
                        <ul>
                            <li className='my-1 text-gray-400 dark:text-white'>
                                <Link href={`/kategori?page=1&tag=berita`}><span className='hover:text-sky-500 font-thin font-mono text-gray-300 cursor-pointer capitalize'>{bahasa("widgettab.submenu")}</span></Link>
                            </li>
                            <li className='my-1 text-gray-400 dark:text-white'>
                                <Link href={`/kategori?page=1&tag=umum`}><span className='hover:text-sky-500 font-thin font-mono text-gray-300 cursor-pointer capitalize'>{bahasa("widgettab.submenu2")}</span></Link>
                            </li>
                            <li className='my-1 text-gray-400 dark:text-white'>
                                <Link href={`/kategori?page=1&tag=artikel`}><span className='hover:text-sky-500 font-thin font-mono text-gray-300 cursor-pointer capitalize'>{bahasa("widgettab.submenu3")}</span></Link>
                            </li>
                            <li className='my-1 text-gray-400 dark:text-white'>
