                ...
                <div className="grid grid-cols-12">
                    <div className="pb-6 col-span-full md:pb-0 md:col-span-4">
                        <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 md:justify-start">
                            ...
                            <span className="self-center text-2xl font-semibold">ZZF News</span>
                        </a>
                    </div>
                    <div className="col-span-6 text-center md:text-left md:col-span-2">
                        <p className="pb-1 text-lg text-gray-700 mb-3 font-semibold dark:text-white">Category</p>
                        <ul>
                            <li className='my-1 text-gray-400 dark:text-white'>
                                <a rel="noopener noreferrer" href="#" className="hover:text-orange-400">Link</a>
                            </li>
                            <li className='my-1 text-gray-400 dark:text-white'>
                                <a rel="noopener noreferrer" href="#" className="hover:text-orange-400">Link</a>
                            </li>
