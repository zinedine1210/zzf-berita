  ...
  return (
      <div className='mb-2 lg:mb-8 flex lg:block gap-2'>
            ...
            <div>
              ...
              <p className='text-xs text-gray-500 dark:text-gray-400 mt-2'>{skeleton ? <Skeleton count={3} height={10}/> : stuff.deskripsi.length > 80 ? <ReactMarkdown>{stuff.deskripsi.substring(0, 80)+"..."}</ReactMarkdown> : <ReactMarkdown>{stuff.deskripsi}</ReactMarkdown>}</p>
            </div>
        </div>
  )
}
